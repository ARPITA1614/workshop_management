class BookingsController < ApplicationController
  def create
    ...
    @charge=@stripe_service.create_stripe_service_charge(@amount_to_be_paid, @stripe_customer.id, @card.id, @workshop)
    ...
    redirect_to workshop_path, notice: 'Your tickets has been booked successfully'
